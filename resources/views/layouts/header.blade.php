    ...
    <nav class="px-4 sm:px-6 flex basis-full items-center w-full mx-auto">
        ...
        <div class="w-full flex items-center justify-end ms-auto gap-x-1 md:gap-x-3">
            <div class="flex flex-row items-center justify-end gap-1">
                <a href="" class="flex items-center gap-x-2 hover:bg-gray-100 px-3 py-2 rounded-full">
                ...
                <div class="hs-dropdown [--placement:bottom-right] relative inline-flex">
                    ...
                    <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-52 bg-white shadow-md rounded-lg mt-2 after:h-4 after:absolute after:-bottom-4 after:start-0 after:w-full before:h-4 before:absolute before:-top-4 before:start-0 before:w-full"
                        role="menu" aria-orientation="vertical" aria-labelledby="hs-dropdown-account">
                        <div class="px-3 py-2 flex flex-col gap-1">
                            <span class="font-bold text-md">{{ Auth::user()->name }}</span>
                            <span class="font-light text-md text-wrap">{{ Auth::user()->email }}</span>
                        </div>
                        <hr class="px-3">
